"""R-MEM-5 combined release: copy new exe + resources/ to release dir, re-zip."""
import os
import shutil

src_dir = r'D:\work\workspace\idea\engine\AetherCode\aethercode-desktop\src-tauri\target\release'
prev_release = r'D:\work\workspace\idea\engine\AetherCode\release\aethercode-0.2.54'
dst_dir = r'D:\work\workspace\idea\engine\AetherCode\release\aethercode-0.2.55'
...
src_jar = r'D:\work\workspace\idea\engine\AetherCode\aethercode\dist\aethercode-0.2.55.jar'
dst_jar = os.path.join(dst_dir, 'aethercode-0.2.55.jar')
shutil.copy2(src_jar, dst_jar)
print(f'copied {src_jar}\n     -> {dst_jar}')

# 5) Copy tui / readme / run-tui scripts from R-MEM-1/2/3/4
