"""R227: zip the new release dir."""
import os
import zipfile

release = r'D:\work\workspace\idea\engine\AetherCode\release\aethercode-0.2.51'
zip_path = os.path.join(release, 'aethercode-0.2.51.zip')
