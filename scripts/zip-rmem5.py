"""R-MEM-5 combined release: zip the new release dir."""
import hashlib
import os
import zipfile

release = r'D:\work\workspace\idea\engine\AetherCode\release\aethercode-0.2.55'
zip_path = os.path.join(release, 'aethercode-0.2.55.zip')
