...
export function findMessageIndex(history, id) {
...
export function planCompactFrom(history, anchorId) {
...
export function planCompactUpTo(history, anchorId) {
    const idx = findMessageIndex(history, anchorId);
    if (idx < 0) {
        return {
            mode: "upTo",
 ...
 */
export function sliceForCompact(history, mode, anchorId) {
    if (mode === "from") {
 ...
 */
export function applyPartialCompact(keptPrefix, summary, keptSuffix, options = {}) {
...
export function applyPartialCompactFrom(plan, summary, options = {}) {
    return applyPartialCompact(plan.keptPrefix, summary, [], options);
}
/** Concatenate summary + kept suffix, dropping the kept prefix. */
export function applyPartialCompactUpTo(plan, summary, options = {}) {
 ...
 */
export function summarizeSliceForPartial(slice, summary, recentKeep, options = {}) {
 ...
 */
export function partialCompactCacheImpact(plan) {
    if (!plan.found) {
